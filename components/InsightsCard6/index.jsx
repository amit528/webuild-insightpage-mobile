  ...
  return (
    <div className="insights-card-5">
      <div className="group-69-5">
        <div className="x1600-i27323159202 valign-text-middle typographyheadlineh3-extrabold-30">
          {x1600I27322868202}
        </div>
        <div className="property-tax-i27323-4 valign-text-middle typography-body-smalltext-14-regular">
          {propertyTaxI27322}
        </div>
      </div>
