  ...
  return (
    <div className="insights-card-1">
      <div className="group-69-1">
        <div className="x1600-i27323153202 valign-text-middle typographyheadlineh3-extrabold-30">
          {x1600I27322862202}
        </div>
        <div className="property-tax-i27323 valign-text-middle typography-body-smalltext-14-regular">
          {propertyTaxI27322}
        </div>
      </div>
