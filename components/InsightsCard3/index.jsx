  ...
  return (
    <div className="insights-card-2">
      <div className="group-69-2">
        <div className="x1600-i27323155202 valign-text-middle typographyheadlineh3-extrabold-30">
          {x1600I27322864202}
        </div>
        <div className="property-tax-i27323-1 valign-text-middle typography-body-smalltext-14-regular">
          {propertyTaxI27322}
        </div>
      </div>
