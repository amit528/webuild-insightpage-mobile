  ...
  return (
    <div className="insights-card-4">
      <div className="group-69-4">
        <div className="x1600-i27323158202 valign-text-middle typographyheadlineh3-extrabold-30">
          {x1600I27322867202}
        </div>
        <p className="property-tax-i27323-3 valign-text-middle typography-body-smalltext-14-regular">
          {propertyTaxI27322}
        </p>
      </div>
