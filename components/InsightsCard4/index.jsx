  ...
  return (
    <div className="insights-card-3">
      <div className="group-69-3">
        <div className="x1600-i27323156202 valign-text-middle typographyheadlineh3-extrabold-30">
          {x1600I27322865202}
        </div>
        <div className="property-tax-i27323-2 valign-text-middle typography-body-smalltext-14-regular">
          {propertyTaxI27322}
        </div>
      </div>
